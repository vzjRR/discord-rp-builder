...
module.exports = {
  ...
  dmMessage: `يا هلا فيك بسيرفر {serverName}! تفضل زور قناة ✈️-enclave-Airport داخل السيرفر.
في حال واجهت اي مشكله في السيرفر او لديك اي اقتراح, تقدر تقدم تذكرة في المكان المخصص.
أهلا وسهلا.`,
};
