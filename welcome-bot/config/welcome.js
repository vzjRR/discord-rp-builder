...
module.exports = {
  ...
  //
  // الروابط: نستخدم {…ChannelUrl} مو {…Channel} داخل الـ DM. منشن القناة <#id>
  // يطلع نص رمادي غير قابل للضغط برسائل الخاص (لأن الرسالة برّا السيرفر)، أما
  // الرابط الكامل discord.com/channels/... فينضغط وينقل العضو للقناة مباشرة.
