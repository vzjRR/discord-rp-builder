...
Products.ingredients = {
    ...
    { name = 'mn_cup',        label = { en = 'Paper Cup',         ar = 'كوب ورقي' },    desc = { en = 'Branded MangoNazlet cup',     ar = 'كوب مانجو نزلت' },         weight = 30,  stack = true, category = 'ingredient', cost = 3,  maxBuy = 400, image = 'mn_cup.png' },
...
Products.desserts = {
    ...
    { name = 'mn_mango_sundae', label = { en = 'Mango Sundae',      ar = 'صنداي مانجو' },   desc = { en = 'The MangoNazlet signature',     ar = 'توقيع مانجو نزلت' },        weight = 480, stack = true, category = 'dessert', price = 290, perishable = true, hunger = 220000, thirst = 90000,  useTime = 4000, consumeAnim = 'eating', image = 'mn_mango_sundae.png' },
