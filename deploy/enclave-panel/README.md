...
> **هل لديك خادم يعمل عليه شيء آخر بالفعل** (مثل Enclave-RP-Store)؟
> استعمل [`EXISTING-SERVER.md`](./EXISTING-SERVER.md) بدلًا من هذه
> الصفحة — سكربت مختلف كُتب خصيصًا ليضيف المنصة دون لمس ما هو قائم:
> مستخدم مستقل، مسارات مستقلة، ومنفذ يُكتشف تلقائيًا بدل ٣٠٠٠، وبلا أي
> تغيير على الجدار الناري. ما تحته هنا لخادم جديد تُنشئه من الصفر.
